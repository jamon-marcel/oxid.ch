        ...
        <div>
          ...
          <div class="form-row">
            ...
            <div class="form-radio">
              <input type="radio" class="visually-hidden" v-model="overlayItem.language" value="0" :id="'language_0'">
              <label :for="'language_0'" class="form-control">DE</label>
              <input type="radio" class="visually-hidden" v-model="overlayItem.language" value="1" :id="'language_1'">
              <label :for="'language_1'" class="form-control">EN</label>
            </div>
          </div>
