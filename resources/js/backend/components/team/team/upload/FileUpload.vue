                  ...
                  <div>
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-radio">
                        <input type="radio" class="visually-hidden" v-model="asset.language" value="0" :id="'language_0_'+index">
                        <label :for="'language_0_'+index" class="form-control">DE</label>
                        <input type="radio" class="visually-hidden" v-model="asset.language" value="1" :id="'language_1_'+index">
                        <label :for="'language_1_'+index" class="form-control">EN</label>
                      </div>
                    </div>
